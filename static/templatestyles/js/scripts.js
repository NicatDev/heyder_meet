$(document).ready(function() {
    ...
    $('.slide-slider-full').owlCarousel({
        ...
        dots:false,
        items:5,
        navText:['<img src="https://thumbs.dreamstime.com/z/left-arrow-concept-vector-linear-icon-isolated-transparent-ba-background-transparency-outline-style-130078187.jpg" alt="icon" />','<img src="https://previews.123rf.com/images/eljanstock/eljanstock1811/eljanstock181109660/111791312-right-arrow-vector-icon-isolated-on-transparent-background-right-arrow-transparency-logo-concept.jpg" alt="icon" />'],
        responsive:{
            0:{
                items:2,
            },
